...
/// Repairs DBs where migration v4 was recorded but `clipper_export_publishes` is missing.
pub struct M008RepairClipperExportPublishes;

impl_migration!(M008RepairClipperExportPublishes, 8, up);
