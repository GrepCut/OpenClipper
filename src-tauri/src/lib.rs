...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::test_benchmark::dataset::test_dataset_list,
            commands::test_benchmark::dataset::test_dataset_get,
            commands::test_benchmark::dataset::test_dataset_create,
            commands::test_benchmark::dataset::test_dataset_update,
            commands::test_benchmark::dataset::test_dataset_update_role,
            commands::test_benchmark::clip::test_clip_update_cohorts,
            commands::test_benchmark::dataset::test_dataset_delete,
            commands::test_benchmark::clip::test_clip_list,
            commands::test_benchmark::clip::test_clip_get,
            commands::test_benchmark::clip::test_clip_create,
            commands::test_benchmark::clip::test_clip_delete,
            commands::test_benchmark::clip::test_clip_annotations_get,
            commands::test_benchmark::clip::test_clip_annotations_replace,
            commands::test_benchmark::clip::test_clip_file_path,
            commands::test_benchmark::dataset::open_test_dataset_dir,
            commands::test_benchmark::benchmark::benchmark_run_create,
            commands::test_benchmark::benchmark::benchmark_run_finish,
            commands::test_benchmark::benchmark::benchmark_run_list,
            commands::test_benchmark::benchmark::benchmark_result_put,
            commands::test_benchmark::benchmark::benchmark_result_list,
            commands::test_benchmark::benchmark::write_test_run_artifact,
            commands::test_benchmark::dataset::test_dataset_export,
            commands::test_benchmark::dataset::test_dataset_import,
            commands::benchmark_miss_export::export_benchmark_miss_frames,
            commands::benchmark_miss_export::export_benchmark_run_miss_frames,
