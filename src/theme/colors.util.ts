export const colors = {
  ...
  dark: {
    ...
    brand: {
      ...
      purpleSoft: "#b392f0",
      purpleText: "#e8e0ff",
      purpleGlow: "rgba(118, 84, 224, 0.6)",
      purpleGlowLight: "rgba(76, 59, 207, 0.5)",
      purpleSoftAlpha12: "rgba(179, 146, 240, 0.12)",
      purpleSoftAlpha85: "rgba(179, 146, 240, 0.85)",
      purpleTextStroke: "rgba(232, 224, 255, 0.3)",
      toggleActiveBg: "rgba(108, 53, 232, 0.08)",
      toggleActiveBorder: "rgba(139, 92, 246, 0.35)",
      toggleActiveHoverBg: "rgba(108, 53, 232, 0.13)",
      toggleActiveHoverBorder: "rgba(139, 92, 246, 0.55)",
    },
    ...
    status: {
      ...
      warning: "#ff9500",
      info: "#0066cc",
      infoGradient: ["#24243e", "#302b63", "#0f0c29"],
      danger: "#ff4444",
      dragPreview: "#4CAF50",
  ...
  light: {
    ...
    brand: {
      ...
      purpleSoft: "#b392f0",
      purpleText: "#ffffff",
      purpleGlow: "rgba(76, 59, 207, 0.5)",
      purpleGlowLight: "rgba(76, 59, 207, 0.5)",
      purpleSoftAlpha12: "rgba(179, 146, 240, 0.12)",
      purpleSoftAlpha85: "rgba(179, 146, 240, 0.85)",
      purpleTextStroke: "rgba(255, 255, 255, 0.4)",
      toggleActiveBg: "rgba(108, 53, 232, 0.07)",
      toggleActiveBorder: "rgba(139, 92, 246, 0.4)",
      toggleActiveHoverBg: "rgba(108, 53, 232, 0.12)",
      toggleActiveHoverBorder: "rgba(139, 92, 246, 0.5)",
    },
