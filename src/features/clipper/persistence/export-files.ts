...
import { getExportDirectory } from "./project-sync";
import { resolveFilePlayableUrl } from '../persistence/tauri-media';
import { isTauri } from "../../../shared/utils/platform";
import { createFileSystemWriteProxy } from "../lib/convert/file-system-write-proxy";
import { getClipperFormatDef } from "../shared/formats";
import type { ClipperFormatResult } from "../shared/state";
import { clipperLog, clipperWarn } from "../shared/logger";
import { pathBackedClipperFile } from "../platform/native-source";
import { ensureClipperProjectDataDir } from "./project-data-files";
