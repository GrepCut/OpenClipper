...
import type { ClipperFormatSettings, ClipperQualityPreset, ClipperResolutionCap } from "../../settings/settings";
import { useClipperUi } from "../../shared/use-clipper-ui";
import { SegmentedControl, SettingSection } from "./SettingControls";
