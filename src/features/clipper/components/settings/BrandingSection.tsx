...
import type { ClipperBrandingSettings, ClipperWatermarkCorner } from "../../settings/settings";
import { clampOverlaySeconds, clampWatermarkScale } from "../../settings/settings";
