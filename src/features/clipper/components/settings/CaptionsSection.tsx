...
import type { CaptionBoxStyle } from '../../lib/captions/animated-caption-render';
import type {
  SubtitleFontFamily,
  SubtitleFontSize,
  SubtitlePosition,
} from '../../lib/captions/subtitle-render';
import type { ClipperCaptionSettings } from "../../settings/settings";
import { clampWordsPerGroup } from "../../settings/settings";
