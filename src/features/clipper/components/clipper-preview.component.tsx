...
import { OutlinedActionButton, getOutlinedActionSurfaceProps, OUTLINED_ACTION_BUTTON_SIZE_PROPS } from "../../../shared/components/buttons/outlined-action-button.component";
...
import { CLIPPER_CARD_FRAME_HEIGHT, CLIPPER_FORMAT_DEFS, CLIPPER_HERO_PREVIEW_HEIGHT } from "../shared/formats.util";
...
interface ClipperPreviewProps {
  ...
  autoPartsSegmentLengthSec: import("../persistence/project-metadata.util").AutoPartsSegmentLengthSec;
  onAutoPartsSegmentLengthChange: (
    lengthSec: import("../persistence/project-metadata.util").AutoPartsSegmentLengthSec,
  ) => void;
