...
import type { ClipperClipPreview, ClipperFormatResult, ClipperPipelineState, ClipSourceMode } from "../shared/state.util";
...
import { buildFrameContext, getActiveClips, syncSessionActiveClips, type ClipperSession } from "../pipeline/session.util";
import {
...
import { runConfirmRangePipeline, runPreparePreviewPipeline } from "../pipeline/range-workflow.util";
import {
...
function clipsToPayload(
  clips: import("../engine/segmentation").ClipperGeneratedClip[],
  rangeWords?: import("../lib/media/transcription-export.util").WordCue[],
  rangeDurationSec = Infinity,
  envelope?: import("../engine/types/audio.types").RmsEnvelope,
): ClipperClipPayload[] {
