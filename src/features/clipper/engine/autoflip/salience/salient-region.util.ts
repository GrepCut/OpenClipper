import type { AutoFlipFaceDetection, NormalizedBox, PoseSubject, SubjectDetection, SubjectDetectionSample } from "../../../shared/smart-crop.util";
import type { KeyFrameSalientInput, SalientRegion, SalientSignalType } from "../../types/autoflip.types";
import type { BuildSalientKeyframesInput } from "../../types/autoflip.types";
import { AUTOFLIP_KEYFRAME_INTERVAL_SEC } from "../config/config.constants";
