import type { FocusPointFrame, KeyFrameSalientInput, NormalizedRect, SceneCameraMotionType, SceneKeyFrameCropSummary } from "../../types/autoflip.types";
import type { SceneMotionInput, SceneMotionResult, SceneZoomInput } from "../../types/autoflip.types";
import { computeFrameCropRegionResult, computeTargetCropSize, cropRectToCentroid, focusBandRegions } from "../geometry/frame-crop-region.util";
