...
import { analyzeSceneMotion, computeSalienceZoomScale } from "../camera/scene-motion";
import type { KeyFrameSalientInput, SalientRegion } from "../config/constants";
import { AUTOFLIP_MIN_ZOOM_SCALE } from "../config/constants";
