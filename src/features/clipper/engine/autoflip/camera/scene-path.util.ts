import { KinematicPathSolver } from "./kinematic-solver.util";
import type { FocusPointFrame, KinematicOptions, NormalizedRect, SceneKeyFrameCropSummary } from "../../types/autoflip.types";
import type { SceneCropInput } from "../../types/autoflip.types";
import { AUTOFLIP_FIELD_OF_VIEW_DEG } from "../config/config.constants";
import { solveAutoFlipPolynomialPath } from "./polynomial-solver.util";
