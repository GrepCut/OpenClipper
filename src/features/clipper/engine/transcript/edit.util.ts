...
import { buildClipsFromWordRanges } from "./ai-clip-builder.util";
import type { AiClipSegmentRange } from "../types/transcript.types";
...
import type { WordMarginOptions } from "../types/transcript.types";
import type { ClipTranscriptEditOp, ClipTranscriptEditResult, WordSelection } from "../types/transcript.types";
